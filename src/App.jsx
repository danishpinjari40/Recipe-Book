...
const App = () => {
	...
	const searchQuery = query ? query : 'chicken biryani';
	// //* this is api key
	const apiKey = '326549e531aceed4c05fd54e58a18378';
	const apiID = 'bf29d630';
	const url = `https://api.edamam.com/api/recipes/v2?type=public&q=${searchQuery}&app_id=${apiID}&app_key=${apiKey}`;
